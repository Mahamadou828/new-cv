...
/**
 * @function CreateWaves Create Waves Effect
 * @returns {void}
 */
...
/**
 * @function ramdomNumber Generate Ramdom String Of Character
 * @param {Number} length Length Of The String Of Characters
 * @returns {String} The Generate String Of Characters
 */
export function RamdomNumber(length = 10) {
  let text = '',
